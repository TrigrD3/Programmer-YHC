    ...
    <div class="col">
      <form action="{{ route('mahasiswa.update', $mahasiswa) }}" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="number" name="semester" id="semester" class="form-control" value="{{ $mahasiswa->semester }}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="number" name="angkatan" id="angkatan" class="form-control" value="{{ $mahasiswa->angkatan }}">
        </div>
